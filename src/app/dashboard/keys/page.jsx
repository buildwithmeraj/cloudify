    ...
    <div className="w-full px-4 pt-2 pb-8 sm:px-6 sm:pt-3 sm:pb-10 lg:px-8 lg:pt-4 lg:pb-12 space-y-6">
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        <article className="rounded-2xl border border-base-300 bg-base-100 p-6 shadow-sm">
          <h2 className="text-lg font-bold text-base-content">Cloudinary Preview</h2>
        ...
        <article className="rounded-2xl border border-base-300 bg-base-100 p-6 shadow-sm">
          <h2 className="text-lg font-bold text-base-content">Public Key Preview</h2>
          <p className="mt-1 text-sm text-base-content/70">
          ...
          <div className="mt-4 space-y-2">
            ...
            {!loading && publicKeys.length === 0 && (
              <p className="text-sm text-base-content/50">No public keys yet.</p>
            )}
